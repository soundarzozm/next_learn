	...
	return (
		<div className="flex justify-center mt-16">
			<div className="flex flex-col justify-center items-center cursor-default">
				...
				<div className="font-sans text-md text-gray-500 flex justify-center items-center mt-1 dark:text-gray-400">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24"
						className="h-4 w-4 mr-2 stroke-purple-600 fill-purple-600 dark:stroke-cyan-600 dark:fill-cyan-600"
					>
						<path d="M12 0c-4.198 0-8 3.403-8 7.602 0 4.198 3.469 9.21 8 16.398 4.531-7.188 8-12.2 8-16.398 0-4.199-3.801-7.602-8-7.602zm0 11c-1.657 0-3-1.343-3-3s1.343-3 3-3 3 1.343 3 3-1.343 3-3 3z" />
					</svg>
					bengaluru, india
				</div>
				<div className="font-sans text-sm text-purple-500 mt-1 dark:text-cyan-500 tracking-widest hover:animate-text-pride duration-200 transition ease-in-out">
					he/him/his
				</div>
				...
				<div className="relative mt-10 group">
					<div className="absolute inset-0.5 opacity-75 group-hover:opacity-100 transition duration-200 rounded-md blur-lg bg-gradient-to-r from-pink-600 via-blue-600 to-green-600 animate-gradient-x"></div>
					<button className="relative rounded-md px-10 py-3 bg-white dark:bg-black text-xs font-normal text-gray-500 dark:text-gray-400 tracking-widest leading-none hover:text-gray-800 dark:hover:text-gray-200 duration-200 transition ease-in-out">
						LEARN MORE &nbsp; →
					</button>
				</div>
			</div>
